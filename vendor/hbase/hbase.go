...
const (
  TCompareOperator_LESS TCompareOperator = 0
  TCompareOperator_LESS_OR_EQUAL TCompareOperator = 1
  TCompareOperator_EQUAL TCompareOperator = 2
  TCompareOperator_NOT_EQUAL TCompareOperator = 3
  TCompareOperator_GREATER_OR_EQUAL TCompareOperator = 4
  TCompareOperator_GREATER TCompareOperator = 5
  TCompareOperator_NO_OP TCompareOperator = 6
)

func (p TCompareOperator) String() string {
  switch p {
  case TCompareOperator_LESS: return "LESS"
  case TCompareOperator_LESS_OR_EQUAL: return "LESS_OR_EQUAL"
  case TCompareOperator_EQUAL: return "EQUAL"
  case TCompareOperator_NOT_EQUAL: return "NOT_EQUAL"
  case TCompareOperator_GREATER_OR_EQUAL: return "GREATER_OR_EQUAL"
  case TCompareOperator_GREATER: return "GREATER"
  case TCompareOperator_NO_OP: return "NO_OP"
  }
  return "<UNSET>"
}
...
func TCompareOperatorFromString(s string) (TCompareOperator, error) {
  switch s {
  case "LESS": return TCompareOperator_LESS, nil 
  case "LESS_OR_EQUAL": return TCompareOperator_LESS_OR_EQUAL, nil 
  case "EQUAL": return TCompareOperator_EQUAL, nil 
  case "NOT_EQUAL": return TCompareOperator_NOT_EQUAL, nil 
  case "GREATER_OR_EQUAL": return TCompareOperator_GREATER_OR_EQUAL, nil 
  case "GREATER": return TCompareOperator_GREATER, nil 
  case "NO_OP": return TCompareOperator_NO_OP, nil 
  }
...
func (p TCompareOperator) MarshalText() ([]byte, error) {
return []byte(p.String()), nil
}

func (p *TCompareOperator) UnmarshalText(text []byte) error {
q, err := TCompareOperatorFromString(string(text))
if (err != nil) {
return err
}
*p = q
...
func (p *TCompareOperator) Scan(value interface{}) error {
v, ok := value.(int64)
if !ok {
return errors.New("Scan value is not int64")
}
*p = TCompareOperator(v)
return nil
}
...
type THBaseService interface {
  ...
  CheckAndMutate(ctx context.Context, table []byte, row []byte, family []byte, qualifier []byte, compareOperator TCompareOperator, value []byte, rowMutations *TRowMutations) (r bool, err error)
  ...
  // 
  ListNamespaces(ctx context.Context) (r []string, err error)
  // Get the type of this thrift server.
  // 
  // @return the type of this thrift server
  GetThriftServerType(ctx context.Context) (r TThriftServerType, err error)
  // Returns the cluster ID for this cluster.
  GetClusterId(ctx context.Context) (r string, err error)
}
...
// check is for the non-existence of the column in question
//  - RowMutations: row mutations to execute if the value matches
func (p *THBaseServiceClient) CheckAndMutate(ctx context.Context, table []byte, row []byte, family []byte, qualifier []byte, compareOperator TCompareOperator, value []byte, rowMutations *TRowMutations) (r bool, err error) {
  var _args70 THBaseServiceCheckAndMutateArgs
  _args70.Table = table
  _args70.Row = row
  _args70.Family = family
  _args70.Qualifier = qualifier
  _args70.CompareOperator = compareOperator
  _args70.Value = value
...
// @return all namespace names
// 
func (p *THBaseServiceClient) ListNamespaces(ctx context.Context) (r []string, err error) {
  var _args122 THBaseServiceListNamespacesArgs
  var _result123 THBaseServiceListNamespacesResult
  if err = p.Client_().Call(ctx, "listNamespaces", &_args122, &_result123); err != nil {
    return
  }
  switch {
  case _result123.Io!= nil:
    return r, _result123.Io
  }
...
// 
// @return the type of this thrift server
func (p *THBaseServiceClient) GetThriftServerType(ctx context.Context) (r TThriftServerType, err error) {
  var _args124 THBaseServiceGetThriftServerTypeArgs
  var _result125 THBaseServiceGetThriftServerTypeResult
  if err = p.Client_().Call(ctx, "getThriftServerType", &_args124, &_result125); err != nil {
    return
  }
...
// Returns the cluster ID for this cluster.
func (p *THBaseServiceClient) GetClusterId(ctx context.Context) (r string, err error) {
  var _args126 THBaseServiceGetClusterIdArgs
  var _result127 THBaseServiceGetClusterIdResult
  if err = p.Client_().Call(ctx, "getClusterId", &_args126, &_result127); err != nil {
    return
  }
...
func NewTHBaseServiceProcessor(handler THBaseService) *THBaseServiceProcessor {
  ...
  self128 := &THBaseServiceProcessor{handler:handler, processorMap:make(map[string]thrift.TProcessorFunction)}
  self128.processorMap["exists"] = &tHBaseServiceProcessorExists{handler:handler}
  self128.processorMap["existsAll"] = &tHBaseServiceProcessorExistsAll{handler:handler}
  self128.processorMap["get"] = &tHBaseServiceProcessorGet{handler:handler}
  self128.processorMap["getMultiple"] = &tHBaseServiceProcessorGetMultiple{handler:handler}
  self128.processorMap["put"] = &tHBaseServiceProcessorPut{handler:handler}
  self128.processorMap["checkAndPut"] = &tHBaseServiceProcessorCheckAndPut{handler:handler}
  self128.processorMap["putMultiple"] = &tHBaseServiceProcessorPutMultiple{handler:handler}
  self128.processorMap["deleteSingle"] = &tHBaseServiceProcessorDeleteSingle{handler:handler}
  self128.processorMap["deleteMultiple"] = &tHBaseServiceProcessorDeleteMultiple{handler:handler}
  self128.processorMap["checkAndDelete"] = &tHBaseServiceProcessorCheckAndDelete{handler:handler}
  self128.processorMap["increment"] = &tHBaseServiceProcessorIncrement{handler:handler}
  self128.processorMap["append"] = &tHBaseServiceProcessorAppend{handler:handler}
  self128.processorMap["openScanner"] = &tHBaseServiceProcessorOpenScanner{handler:handler}
  self128.processorMap["getScannerRows"] = &tHBaseServiceProcessorGetScannerRows{handler:handler}
  self128.processorMap["closeScanner"] = &tHBaseServiceProcessorCloseScanner{handler:handler}
  self128.processorMap["mutateRow"] = &tHBaseServiceProcessorMutateRow{handler:handler}
  self128.processorMap["getScannerResults"] = &tHBaseServiceProcessorGetScannerResults{handler:handler}
  self128.processorMap["getRegionLocation"] = &tHBaseServiceProcessorGetRegionLocation{handler:handler}
  self128.processorMap["getAllRegionLocations"] = &tHBaseServiceProcessorGetAllRegionLocations{handler:handler}
  self128.processorMap["checkAndMutate"] = &tHBaseServiceProcessorCheckAndMutate{handler:handler}
  self128.processorMap["getTableDescriptor"] = &tHBaseServiceProcessorGetTableDescriptor{handler:handler}
  self128.processorMap["getTableDescriptors"] = &tHBaseServiceProcessorGetTableDescriptors{handler:handler}
  self128.processorMap["tableExists"] = &tHBaseServiceProcessorTableExists{handler:handler}
  self128.processorMap["getTableDescriptorsByPattern"] = &tHBaseServiceProcessorGetTableDescriptorsByPattern{handler:handler}
  self128.processorMap["getTableDescriptorsByNamespace"] = &tHBaseServiceProcessorGetTableDescriptorsByNamespace{handler:handler}
  self128.processorMap["getTableNamesByPattern"] = &tHBaseServiceProcessorGetTableNamesByPattern{handler:handler}
  self128.processorMap["getTableNamesByNamespace"] = &tHBaseServiceProcessorGetTableNamesByNamespace{handler:handler}
  self128.processorMap["createTable"] = &tHBaseServiceProcessorCreateTable{handler:handler}
  self128.processorMap["deleteTable"] = &tHBaseServiceProcessorDeleteTable{handler:handler}
  self128.processorMap["truncateTable"] = &tHBaseServiceProcessorTruncateTable{handler:handler}
  self128.processorMap["enableTable"] = &tHBaseServiceProcessorEnableTable{handler:handler}
  self128.processorMap["disableTable"] = &tHBaseServiceProcessorDisableTable{handler:handler}
  self128.processorMap["isTableEnabled"] = &tHBaseServiceProcessorIsTableEnabled{handler:handler}
  self128.processorMap["isTableDisabled"] = &tHBaseServiceProcessorIsTableDisabled{handler:handler}
  self128.processorMap["isTableAvailable"] = &tHBaseServiceProcessorIsTableAvailable{handler:handler}
  self128.processorMap["isTableAvailableWithSplit"] = &tHBaseServiceProcessorIsTableAvailableWithSplit{handler:handler}
  self128.processorMap["addColumnFamily"] = &tHBaseServiceProcessorAddColumnFamily{handler:handler}
  self128.processorMap["deleteColumnFamily"] = &tHBaseServiceProcessorDeleteColumnFamily{handler:handler}
  self128.processorMap["modifyColumnFamily"] = &tHBaseServiceProcessorModifyColumnFamily{handler:handler}
  self128.processorMap["modifyTable"] = &tHBaseServiceProcessorModifyTable{handler:handler}
  self128.processorMap["createNamespace"] = &tHBaseServiceProcessorCreateNamespace{handler:handler}
  self128.processorMap["modifyNamespace"] = &tHBaseServiceProcessorModifyNamespace{handler:handler}
  self128.processorMap["deleteNamespace"] = &tHBaseServiceProcessorDeleteNamespace{handler:handler}
  self128.processorMap["getNamespaceDescriptor"] = &tHBaseServiceProcessorGetNamespaceDescriptor{handler:handler}
  self128.processorMap["listNamespaceDescriptors"] = &tHBaseServiceProcessorListNamespaceDescriptors{handler:handler}
  self128.processorMap["listNamespaces"] = &tHBaseServiceProcessorListNamespaces{handler:handler}
  self128.processorMap["getThriftServerType"] = &tHBaseServiceProcessorGetThriftServerType{handler:handler}
  self128.processorMap["getClusterId"] = &tHBaseServiceProcessorGetClusterId{handler:handler}
return self128
}
...
var retval bool
  var err2 error
  if retval, err2 = p.handler.CheckAndMutate(ctx, args.Table, args.Row, args.Family, args.Qualifier, args.CompareOperator, args.Value, args.RowMutations); err2 != nil {
  switch v := err2.(type) {
    case *TIOError:
  result.Io = v
    default:
...
func (p *tHBaseServiceProcessorGetClusterId) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
    oprot.WriteMessageBegin("getClusterId", thrift.EXCEPTION, seqId)
    x.Write(oprot)
    oprot.WriteMessageEnd()
    oprot.Flush(ctx)
    return false, err
...
var retval string
  ...
  if retval, err2 = p.handler.GetClusterId(ctx); err2 != nil {
    x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing getClusterId: " + err2.Error())
    oprot.WriteMessageBegin("getClusterId", thrift.EXCEPTION, seqId)
    x.Write(oprot)
    oprot.WriteMessageEnd()
    oprot.Flush(ctx)
  ...
  if err2 = oprot.WriteMessageBegin("getClusterId", thrift.REPLY, seqId); err2 != nil {
    err = err2
  }
  if err2 = result.Write(oprot); err == nil && err2 != nil {
    err = err2
...
func (p *THBaseServiceExistsAllArgs)  ReadField2(iprot thrift.TProtocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Tgets = append(p.Tgets, _elem130)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *THBaseServicePutMultipleArgs)  ReadField2(iprot thrift.TProtocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Tputs = append(p.Tputs, _elem134)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *THBaseServiceDeleteMultipleArgs)  ReadField2(iprot thrift.TProtocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Tdeletes = append(p.Tdeletes, _elem135)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
type THBaseServiceCheckAndMutateArgs struct {
  ...
  Family []byte `thrift:"family,3,required" db:"family" json:"family"`
  Qualifier []byte `thrift:"qualifier,4,required" db:"qualifier" json:"qualifier"`
  CompareOperator TCompareOperator `thrift:"compareOperator,5,required" db:"compareOperator" json:"compareOperator"`
...
func (p *THBaseServiceCheckAndMutateArgs) GetCompareOperator() TCompareOperator {
  return p.CompareOperator
}
...
func (p *THBaseServiceCheckAndMutateArgs) Read(iprot thrift.TProtocol) error {
  ...
  var issetFamily bool = false;
  var issetQualifier bool = false;
  var issetCompareOperator bool = false;
  ...
  if !issetCompareOperator{
    return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("Required field CompareOperator is not set"));
  }
...
func (p *THBaseServiceCheckAndMutateArgs)  ReadField5(iprot thrift.TProtocol) error {
  ...
  temp := TCompareOperator(v)
  p.CompareOperator = temp
}
  return nil
}
...
func (p *THBaseServiceCheckAndMutateArgs) writeField5(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("compareOperator", thrift.I32, 5); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 5:compareOperator: ", p), err) }
  if err := oprot.WriteI32(int32(p.CompareOperator)); err != nil {
  return thrift.PrependError(fmt.Sprintf("%T.compareOperator (5) field write error: ", p), err) }
  if err := oprot.WriteFieldEnd(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field end error 5:compareOperator: ", p), err) }
  return err
}
...
func (p *THBaseServiceGetTableDescriptorsArgs)  ReadField1(iprot thrift.TProtocol) error {
  ...
  for i := 0; i < size; i ++ {
    ...
    p.Tables = append(p.Tables, _elem140)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
var _elem146 []byte
    ...
    p.SplitKeys = append(p.SplitKeys, _elem146)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
var _elem147 []byte
    ...
    p.SplitKeys = append(p.SplitKeys, _elem147)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
...
func (p *THBaseServiceListNamespacesArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *THBaseServiceListNamespacesArgs) Write(oprot thrift.TProtocol) error {
...
func (p *THBaseServiceListNamespacesResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *THBaseServiceListNamespacesResult)  ReadField0(iprot thrift.TProtocol) error {
  _, size, err := iprot.ReadListBegin()
  if err != nil {
    return thrift.PrependError("error reading list begin: ", err)
  }
...
func (p *THBaseServiceListNamespacesResult)  ReadField1(iprot thrift.TProtocol) error {
  p.Io = &TIOError{}
  if err := p.Io.Read(iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Io), err)
  }
...
func (p *THBaseServiceListNamespacesResult) Write(oprot thrift.TProtocol) error {
...
func (p *THBaseServiceListNamespacesResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
    if err := oprot.WriteFieldBegin("success", thrift.LIST, 0); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err) }
...
func (p *THBaseServiceListNamespacesResult) writeField1(oprot thrift.TProtocol) (err error) {
  if p.IsSetIo() {
    if err := oprot.WriteFieldBegin("io", thrift.STRUCT, 1); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:io: ", p), err) }
    if err := p.Io.Write(oprot); err != nil {
...
func (p *THBaseServiceGetThriftServerTypeArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *THBaseServiceGetThriftServerTypeArgs) Write(oprot thrift.TProtocol) error {
...
func (p *THBaseServiceGetThriftServerTypeResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *THBaseServiceGetThriftServerTypeResult)  ReadField0(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(); err != nil {
  return thrift.PrependError("error reading field 0: ", err)
} else {
...
func (p *THBaseServiceGetThriftServerTypeResult) Write(oprot thrift.TProtocol) error {
...
func (p *THBaseServiceGetThriftServerTypeResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
    if err := oprot.WriteFieldBegin("success", thrift.I32, 0); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err) }
    if err := oprot.WriteI32(int32(*p.Success)); err != nil {
...
func (p *THBaseServiceGetClusterIdArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *THBaseServiceGetClusterIdArgs) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("getClusterId_args"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
  }
  if err := oprot.WriteFieldStop(); err != nil {
...
func (p *THBaseServiceGetClusterIdResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *THBaseServiceGetClusterIdResult)  ReadField0(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
  return thrift.PrependError("error reading field 0: ", err)
} else {
  p.Success = &v
...
func (p *THBaseServiceGetClusterIdResult) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("getClusterId_result"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField0(oprot); err != nil { return err }
  }
...
func (p *THBaseServiceGetClusterIdResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
